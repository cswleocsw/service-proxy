(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ServiceProxy"] = factory();
	else
		root["ServiceProxy"] = factory();
})(this, function() {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(87), __webpack_require__(312)(module)))
...
var _ServiceProxy = __webpack_require__(121);

var _ServiceProxy2 = _interopRequireDefault(_ServiceProxy);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _ServiceProxy2.default;
module.exports = exports['default'];
...
var Proxy = function () {
  ...
  _createClass(Proxy, null, [{
    key: 'request',
    value: function request(service) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (options.header && (0, _lodash.isArray)(options.header)) {
          headers = headers.concat(options.header);
        }

        (0, _lodash.each)(headers, function (header) {
          return httpRequest.set(header.key, header.value);
        });
...
var _Proxy = __webpack_require__(119);

var _Proxy2 = _interopRequireDefault(_Proxy);

var _Service = __webpack_require__(120);
...
var ServiceProxy = function () {
  ...
  _createClass(ServiceProxy, [{
    ...
    value: function register(key) {
      ...
      this.map.set(key, new _Service2.default(options));
    }
  }, {
    key: 'request',
    value: function request(key) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

      var service = this.map.get(key);

      if (!service || !(service instanceof _Service2.default)) {
        throw new Error('request service ' + key + ' is not define');
      }

      return _Proxy2.default.request(service, options);
    }
  }, {
    key: 'get',
    ...
    value: function list() {
      var arr = [];
      this.map.forEach(function (_, key) {
        return arr.push(key);
      });
      return arr;
    }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(87), __webpack_require__(304)))
