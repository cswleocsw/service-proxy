...
/***/ function(module, exports, __webpack_require__) {
	...
	var ServiceProxy = function () {
	  function ServiceProxy() {
	    ...
	    this.map = new Map();
	    this.proxy = new _Proxy2.default();
	  }

	  ServiceProxy.prototype.register = function register(key) {
	  ...
	  ServiceProxy.prototype.request = function request(key) {
	    var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
	  ...
	  ServiceProxy.prototype.get = function get(key) {
	    return this.map.get(key);
	  };

	  ServiceProxy.prototype.list = function list() {
	    var arr = [];
	  ...
	  ServiceProxy.prototype.getName = function getName() {
	    return this.name;
	  };
	...
	var Proxy = function () {
	  ...
	  Proxy.prototype.request = function request(service) {
	    ...
	    var promise = new Promise(function (resolve, reject) {
	      ...
	      // query
	      if (options.query) {
	        (0, _lodash.each)(options.query, function (o) {
	          return httpRequest.query(o);
	        });
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Service = function () {
	  ...
	  Service.prototype.getType = function getType() {
	    return this.type;
	  };

	  Service.prototype.getHeader = function getHeader() {
	    return this.header;
	  };
